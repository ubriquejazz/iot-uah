...
if __name__ == '__main__':
    ...
    while True:
        ...
        try:    
            ...
            url = base_url + urllib.parse.urlencode({'compId' : component_id, 'temperature' : temperature_val, 'humidity' : humidity_val})
            ...
            #The api_key token can be passed as a URL parameter or as cookies.
            ...
            # limit by setting the below to this device's IP address (an http 403 error could indicate you need the below)
